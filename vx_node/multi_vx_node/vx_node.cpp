...
int main()
{
	...
	vx_image iimg1 = vxCreateImage(cont, 640, 640, VX_DF_IMAGE_U8);
	vx_node nodeObj1 = vxSobel3x3Node(gra, iimg, iimg1, oimg);


	// This is the graph with multi node and VerifyGraph verify the state of node and fails if the type and size mismatch 
